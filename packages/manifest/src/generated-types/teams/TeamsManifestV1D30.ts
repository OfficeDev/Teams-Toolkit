// To parse this data:
//
//   import { Convert, TeamsManifestV1D30 } from "./file";
//
//   const teamsManifestV1D30 = Convert.toTeamsManifestV1D30(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface TeamsManifestV1D30 {
  $schema?: string;
  /**
   ...
   */
  authorization?: TeamsManifestV1D30Authorization;
 ...
 * Specify and consolidates authorization related information for the App.
 */
export interface TeamsManifestV1D30Authorization {
  /**
...
export type HostMustSupportFunctionalityName =
  "dialogUrl" | "dialogUrlBot" | "dialogAdaptiveCard" | "dialogAdaptiveCardBot";
...
export interface Options {
  /**
   * Specifies the actions to take during a mail send event. The property may be omitted, but
   * a literal null is not a valid value.
   */
  sendMode?: SendMode;
  /**
   * Specifies the internet header name used to identify a message during a decryption event.
   * Follows email header name constraints.
   */
  headerName?: string;
}
...
export class Convert {
  public static toTeamsManifestV1D30(json: string): TeamsManifestV1D30 {
    return cast(JSON.parse(json), r("TeamsManifestV1D30"));
  }

  public static teamsManifestV1D30ToJson(value: TeamsManifestV1D30): string {
    return JSON.stringify(uncast(value, r("TeamsManifestV1D30")), null, 4);
  }
}
...
const typeMap: any = {
  TeamsManifestV1D30: o(
    [
      ...
      {
        json: "supportsChannelFeatures",
        js: "supportsChannelFeatures",
        typ: u(undefined, r("SupportsChannelFeatures")),
      },
      {
      ...
      },
      {
        json: "authorization",
        js: "authorization",
        typ: u(undefined, r("TeamsManifestV1D30Authorization")),
      },
      ...
      {
        json: "agenticUserTemplates",
        js: "agenticUserTemplates",
        typ: u(undefined, a(r("AgenticUserTemplateRef"))),
      },
      {
  ...
  RemoteMCPServer: o(
    [
      ...
      {
        json: "mcpToolDescription",
        js: "mcpToolDescription",
        typ: u(undefined, r("MCPToolDescription")),
      },
      {
        json: "authorization",
        js: "authorization",
        typ: u(undefined, r("RemoteMCPServerAuthorization")),
      },
    ],
    false
  ),
  ...
  MCPToolDescription: o([{ json: "file", js: "file", typ: "" }], false),
  AgentSkill: o([{ json: "folder", js: "folder", typ: "" }], false),
  ...
  TeamsManifestV1D30Authorization: o(
  ...
  ComposeExtensionAuthorization: o(
    [
      ...
      {
        json: "oAuthConfiguration",
        js: "oAuthConfiguration",
        typ: u(undefined, r("OAuthConfiguration")),
      },
    ],
    false
  ),
  ...
  Options: o(
    [
      { json: "sendMode", js: "sendMode", typ: u(undefined, r("SendMode")) },
      { json: "headerName", js: "headerName", typ: u(undefined, "") },
    ],
    false
  ),
  ...
  ExtensionFunction: o(
    [
      ...
      {
        json: "requiresStreamParameterAddresses",
        js: "requiresStreamParameterAddresses",
        typ: u(undefined, true),
      },
  ...
  PurpleType: ["basic", "prompt"],
  CommandListScope: ["copilot", "groupChat", "personal", "team"],
  CommandListTrigger: ["mention", "slash"],
