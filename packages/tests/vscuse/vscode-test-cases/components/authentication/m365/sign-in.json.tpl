{
  ...
  "steps": [
    ...
    {
      "step_id": "step_signInM365_reopenAccounts_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "key_press",
      "parameters": {
        "key": "f1"
    ...
    {
      "step_id": "step_signInM365_assertPalette_{{text:instanceSuffix}}",
      "agent": "assertion",
      "tool": "",
      "parameters": {},
      ...
      "retry_count": 0,
      "continue_on_error": "false",
      "depends_on": ["step_signInM365_reopenAccounts_{{text:instanceSuffix}}"],
      "preconditions": [],
      "postconditions": [],
      "tags": [
        "component:authentication",
    ...
    {
      "step_id": "step_signInM365_filterAccounts_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "type_text",
      "parameters": {
      ...
      "retry_count": 0,
      "continue_on_error": "false",
      "depends_on": ["step_signInM365_assertPalette_{{text:instanceSuffix}}"],
      "preconditions": [],
      "postconditions": [],
      "tags": ["component:authentication", "account:m365"]
    },
    {
      "step_id": "step_signInM365_assertAccountsCommand_{{text:instanceSuffix}}",
      "agent": "assertion",
      "tool": "",
      "parameters": {},
      ...
      "retry_count": 0,
      "continue_on_error": "false",
      "depends_on": ["step_signInM365_filterAccounts_{{text:instanceSuffix}}"],
      "preconditions": [],
      "postconditions": [],
      "tags": [
        "component:authentication",
    ...
    {
      "step_id": "step_signInM365_openAccounts_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "key_press",
      "parameters": {
        "key": "enter"
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_signInM365_assertAccountsCommand_{{text:instanceSuffix}}"
      ],
      "preconditions": [],
      "postconditions": [],
      "tags": ["component:authentication", "account:m365"]
    },
    {
      ...
      "retry_count": 0,
      "continue_on_error": "false",
      "depends_on": ["step_signInM365_openAccounts_{{text:instanceSuffix}}"],
      "preconditions": [],
      "postconditions": [],
      "tags": [
        "component:authentication",
    ...
    {
      "step_id": "step_signInM365_closeAccounts_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "key_press",
      "parameters": {
        "key": "esc"
      ...
      "retry_count": 0,
      "continue_on_error": "false",
      "depends_on": ["step_signInM365_assertReady_{{text:instanceSuffix}}"],
      "preconditions": [],
      "postconditions": [],
      "tags": ["component:authentication", "account:m365"]
    }
