{
  ...
  "steps": [
    ...
    },
    {
      ...
      "tool": "",
      "parameters": {},
      "description": "@assertion the Accounts View result is first and the Microsoft 365 Agents: Accounts command is second and selectable in the active Command Palette.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
      "continue_on_error": "false",
