  ...
  "steps": [
    {
      ...
      "description": "@code execute the supplied generated bash script exactly as authored and read its exact PROJECT_DIR under /home/vscode/AgentsToolkitProjects/ from that script; add {{text:variableName}} to the generated App Service appSettings with exactly the value the script assigns, do not reinterpret or regenerate the script, do not use /workspace, and do not log that value.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
