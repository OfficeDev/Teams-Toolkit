  ...
  "steps": [
    {
      ...
      "description": "@code set {{text:variableName}} in the envs mapping the local lifecycle writes into .localConfigs to exactly the value the reference script assigns, without logging that value.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
