  ...
  "steps": [
    {
      ...
      "tool": "",
      "parameters": {},
      "description": "@assertion the Microsoft 365 Copilot message input is visible on a page for an agent whose name starts with ${{var:app_name}}.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
    ...
    },
    {
      ...
      "description": "Click the \"Message\" input box in the Microsoft 365 Copilot web application.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
      "continue_on_error": "false",
