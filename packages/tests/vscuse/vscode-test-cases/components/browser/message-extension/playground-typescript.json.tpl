{
  "component": {
    ...
    "id": "validateMessageExtensionPlaygroundTypeScript",
    "parameters": ["instanceSuffix"]
  },
  "steps": [
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_01_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "description": "Click the \"+\" button at the bottom of the chat input box in the Microsoft 365 Agents Playground web application interface to open the message extension type menu.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_02_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_01_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_03_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "description": "Click the \"Specify Command ID or Parameter\" expandable section in the \"Search-Based Message Extension\" popup within the Microsoft 365 Agents Playground web application.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_02_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_04_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "description": "Click the \"Command ID\" input field in the \"Specify Command ID or Parameter\" section within the Microsoft 365 Agents Playground web interface.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_03_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_05_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "type_text",
      "parameters": {
        "text": "searchQuery"
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_04_{{text:instanceSuffix}}"
      ],
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_06_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "description": "Click the \"Enter a search term\" input field in the \"Specify Command ID or Parameter\" dialog within the Microsoft 365 Agents Playground web application.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_05_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_07_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "type_text",
      "parameters": {
        "text": "test"
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_06_{{text:instanceSuffix}}"
      ],
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_08_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_07_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_09_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "description": "Click the Send (paper plane) button in the message input box at the bottom of the Microsoft 365 Agents Playground chat interface.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_08_{{text:instanceSuffix}}"
      ],
      "preconditions": [
        "dhash:607:732:16:5:9ce23c87a9a9873c",
        "dhash:607:732:96:5:02020212ceca364e",
        "dhash:607:732:0:10:44c27b1180825070"
      ],
      "postconditions": [],
      "tags": [
        "component:browser",
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_10_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "description": "Click the \"+\" (attach) button in the message input box at the bottom of the Microsoft 365 Agents Playground chat interface.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_09_{{text:instanceSuffix}}"
      ],
      "preconditions": [
        "dhash:567:716:16:5:4626862626862606",
        "dhash:567:716:96:5:0008130d0d130000",
        "dhash:567:716:0:10:4cd07331d2c20248"
      ],
      "postconditions": [],
      "tags": [
        "component:browser",
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_11_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_10_{{text:instanceSuffix}}"
      ],
      "preconditions": [
        "dhash:586:636:16:5:106409dc32cc4555",
        "dhash:586:636:96:5:00266ed22646b85a",
        "dhash:586:636:0:10:4cd07331d2c208c0"
      ],
      "postconditions": [],
      "tags": [
        "component:browser",
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_12_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "type_text",
      "parameters": {
        "text": "createCard"
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_11_{{text:instanceSuffix}}"
      ],
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_13_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_12_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_14_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_13_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_15_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_14_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_16_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "type_text",
      "parameters": {
        "text": "1"
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_15_{{text:instanceSuffix}}"
      ],
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_17_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_16_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_18_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "type_text",
      "parameters": {
        "text": "2"
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_17_{{text:instanceSuffix}}"
      ],
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_19_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_18_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_20_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "type_text",
      "parameters": {
        "text": "3"
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_19_{{text:instanceSuffix}}"
      ],
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_21_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_20_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_22_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_21_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_23_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "description": "Click the \"+\" (add) button in the message compose box at the bottom of the Microsoft 365 Agents Playground chat interface to open the message extension options menu.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_22_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_24_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_23_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_25_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "type_text",
      "parameters": {
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_24_{{text:instanceSuffix}}"
      ],
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_26_{{text:instanceSuffix}}",
      "agent": "interaction",
      "tool": "click",
      "parameters": {
        "button": "left",
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_25_{{text:instanceSuffix}}"
      ],
      "preconditions": [
    ...
    {
      "step_id": "step_validateMessageExtensionPlaygroundTypeScript_27_{{text:instanceSuffix}}",
      "agent": "assertion",
      "tool": "",
      "parameters": {},
      ...
      "continue_on_error": "false",
      "depends_on": [
        "step_validateMessageExtensionPlaygroundTypeScript_26_{{text:instanceSuffix}}"
      ],
      "preconditions": [],
      "postconditions": [],
      "tags": [
