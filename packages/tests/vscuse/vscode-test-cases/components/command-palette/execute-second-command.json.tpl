{
  "component": {
    ...
    "parameters": ["firstCommandTitle", "instanceSuffix", "commandTitle"]
  },
  "steps": [
    {
    ...
    },
    {
      ...
      "retry_count": 0,
      "continue_on_error": "false",
      "depends_on": ["step_executeSecondCommand_open_{{text:instanceSuffix}}"],
      "preconditions": [],
      "postconditions": [],
      "tags": [
    ...
    {
      "step_id": "step_executeSecondCommand_assertResults_{{text:instanceSuffix}}",
      "agent": "assertion",
      "tool": "",
      "parameters": {},
      "description": "@assertion the Command Palette input box reads >{{text:commandTitle}}, {{text:firstCommandTitle}} is the highlighted first result, and {{text:commandTitle}} is the second selectable result.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
      "continue_on_error": "false",
    ...
    },
    {
      ...
      "description": "Press Down to highlight the second filtered command.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
      "continue_on_error": "false",
      "depends_on": [
        "step_executeSecondCommand_assertResults_{{text:instanceSuffix}}"
      ],
      "preconditions": [],
      "postconditions": [],
      "tags": ["component:command-palette", "action:execute-command"]
    },
    {
      ...
      "tool": "",
      "parameters": {},
      "description": "@assertion the command {{text:commandTitle}} is highlighted in the filtered Command Palette.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
      "continue_on_error": "false",
      "depends_on": ["step_executeSecondCommand_next_{{text:instanceSuffix}}"],
      "preconditions": [],
      "postconditions": [],
      "tags": [
        "component:command-palette",
    ...
    },
    {
      ...
      "description": "Press Enter to execute the highlighted Command Palette command.",
      "content_refs": [],
      "timeout": 30,
      "retry_count": 0,
      "continue_on_error": "false",
