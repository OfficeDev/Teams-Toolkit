...
| SCN-CREATE-APIPLUGIN-OPENAPI-04 | L1   | scaffold completes                                                                          | inspect `appPackage/manifest.json`            | `manifestVersion == "1.30"`; the env ref `id == "${{TEAMS_APP_ID}}"` survives render; `copilotAgents.declarativeAgents[0] == { id: "declarativeAgent", file: "declarativeAgent.json" }`                                                                                                                                                                            |
