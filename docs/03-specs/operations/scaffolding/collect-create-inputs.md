...
| CCI-17 | L1 | a VS Code descriptor language list containing `python` | `runCreateInputs` asks the language axis | the Python language option keeps label `Python` and carries the localized `Preview` description, matching the v3 Teams Agents and Apps language picker |
