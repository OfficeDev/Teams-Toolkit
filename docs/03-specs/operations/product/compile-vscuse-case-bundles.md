...
| VCB-104 | Given the image build checks out a source ref that differs from the workflow dispatch ref, its source-ref tag, source-SHA tag, and OCI revision label identify the checked-out ref and commit, so consumers cannot mistake an image built from another branch for the dispatched branch.                                                                                                                                                                                                                                                                                           |
